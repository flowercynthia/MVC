...
namespace TestEmpty
{
    ...
    public class ApplicationUserManager : UserManager<UserModel, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<UserModel, RoleModel, int, UserLoginModel, UserRoleModel, UserClaimModel>(context.Get<EmptyDbContext>()));
            ...
            manager.RegisterTwoFactorProvider("Código telefónico", new PhoneNumberTokenProvider<UserModel, int>
            {
                MessageFormat = "Su código de seguridad es {0}"
            });
            manager.RegisterTwoFactorProvider("Código de correo electrónico", new EmailTokenProvider<UserModel, int>
            {
